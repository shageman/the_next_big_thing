class AnnoyanceMeter
  ...
  def annoyance_level(repetition_count)
    ...
    index = repetition_count * AnnoyanceLevels.levels.count/limit.to_f
    index_to_access = [index, AnnoyanceLevels.levels.count - 1].min

    annoyance_level = AnnoyanceLevels.levels[index_to_access]
